...
const SECTIONS = [
  {
    ...
    body: 'Google 계정 연동 로그인 시 이메일 주소, 이름, 프로필 사진을 수집합니다. 서비스 이용 과정에서 방문 페이지, 접속 시각, 브라우저·기기 정보 등 비식별 이용 통계가 Google Analytics 4를 통해 수집될 수 있습니다. 이름·이메일·결제정보는 Google Analytics로 전송하지 않습니다. 유료 구독 결제 시 결제 정보는 결제대행사(토스페이먼츠)가 처리하며, 서비스는 카드번호 등 민감한 결제 정보를 직접 저장하지 않습니다.',
  },
  {
  ...
  {
    title: '4. 제3자 제공',
    body: '이용자의 개인정보를 제3자에게 제공하지 않습니다. 다만 통계 분석을 위해 Google Analytics 4가 비식별 이용 정보를 처리할 수 있으며, 결제 처리를 위해 토스페이먼츠에 결제에 필요한 최소한의 정보가 전달됩니다.',
  },
  {
    title: '5. 이용자의 권리',
